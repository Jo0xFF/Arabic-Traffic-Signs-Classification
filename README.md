...
## Table of Contents
- [Arabic traffic signs classification](#arabic-traffic-signs-classification)
  - [Table of Contents](#table-of-contents)
  - [Overview](#overview)
  - [What kind of traffic signs](#what-kind-of-traffic-signs)
  - [How it works](#how-it-works)
  - [Data](#data)
  - [Splitting ratios](#splitting-ratios)
  - [EDA](#eda)
    - [Imbalance class](#imbalance-class)
    - [Inspect image shapes](#inspect-image-shapes)
  - [Architectures](#architectures)
    - [Baseline architecture](#baseline-architecture)
    - [Baseline killer architecture](#baseline-killer-architecture)
  - [Wandb(Weights & Biases) Experiment monitoring](#wandbweights--biases-experiment-monitoring)
  - [Loss metrics](#loss-metrics)
    - [Baseline losses metrics](#baseline-losses-metrics)
    - [Baseline killer loss metrics](#baseline-killer-loss-metrics)
  - [Confusion matrix](#confusion-matrix)
  - [F1 score](#f1-score)
  - [Predictions on test dataset](#predictions-on-test-dataset)
    - [For Baseline architecture](#for-baseline-architecture)
    - [For Baseline killer architecture](#for-baseline-killer-architecture)
